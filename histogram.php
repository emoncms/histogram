...
class Histogram {
    ...
    public function kwh_at_cop($id_elec,$id_heat,$start,$end,$histogram_div,$interval) {
    ...
    function hwh_at_temperature($id_power,$id_flowT,$start,$end,$histogram_div,$interval) {
        $histogram_div = (float) $histogram_div;
        $interval = (int) $interval;
        ...
        $flowT_data = $this->feed->get_data($id_flowT,$start,$end,$interval,1,"UTC","notime");
